/*! jQuery Fancytree Plugin - 2.27.0 - 2017-12-16T09:14:27Z
...
/*! Extension 'jquery.fancytree.dnd5.min.js' */!function(e){"function"==typeof define&&define.amd?define(["jquery","./jquery.fancytree"],e):"object"==typeof module&&module.exports?(require("./jquery.fancytree"),module.exports=e(require("jquery"))):e(jQuery)}(function(e){"use strict";function r(r,a){if(a.options.dnd5.scroll&&function(r,t){var a,o,n=r.options.dnd5,d=r.$scrollParent[0],s=n.scrollSensitivity,i=n.scrollSpeed,l=0;d!==document&&"HTML"!==d.tagName?(a=r.$scrollParent.offset(),o=d.scrollTop,a.top+d.offsetHeight-t.pageY<s?d.scrollHeight-r.$scrollParent.innerHeight()-o>0&&(d.scrollTop=l=o+i):o>0&&t.pageY-a.top<s&&(d.scrollTop=l=o-i)):(o=e(document).scrollTop())>0&&t.pageY-o<s?(l=o-i,e(document).scrollTop(l)):e(window).height()-(t.pageY-o)<s&&(l=o+i,e(document).scrollTop(l)),l&&r.debug("autoScroll: "+l+"px")}(a.tree,r),!a.node)return a.tree.warn("Ignore dragover for non-node"),v;var o,f,c,y=null,b=a.tree,h=b.options.dnd5,m=a.node,x=a.otherNode,E="center",C=e(m.span),D=C.find("span.fancytree-title");if(!1===u)return b.info("Ignore dragover, since dragenter returned false"),!1;if("string"==typeof u?e.error("assert failed: dragenter returned string"):(f=C.offset(),c=(r.pageY-f.top)/C.height(),u.after&&c>.75?y="after":!u.over&&u.after&&c>.5?y="after":u.before&&c<=.25?y="before":!u.over&&u.before&&c<=.5?y="before":u.over&&(y="over"),h.preventVoidMoves&&(m===x?(m.debug("drop over source node prevented"),y=null):"before"===y&&x&&m===x.getNextSibling()?(m.debug("drop after source node prevented"),y=null):"after"===y&&x&&m===x.getPrevSibling()?(m.debug("drop before source node prevented"),y=null):"over"===y&&x&&x.parent===m&&x.isLastSibling()&&(m.debug("drop last child over own parent prevented"),y=null))),a.hitMode=y,y&&h.dragOver&&(h.dragOver(m,a),y=a.hitMode),v=y,"after"===y||"before"===y||"over"===y){switch(o=h.dropMarkerOffsetX||0,y){case"before":E="top",o+=h.dropMarkerInsertOffsetX||0;break;case"after":E="bottom",o+=h.dropMarkerInsertOffsetX||0}g.toggleClass(d,"after"===y).toggleClass(i,"over"===y).toggleClass(s,"before"===y).show().position(t.fixPositionOptions({my:"left"+function(e){return 0===e?"":e>0?"+"+e:""+e}(o)+" center",at:"left "+E,of:D}))}else g.hide();return e(m.span).toggleClass(p,"after"===y||"before"===y||"over"===y).toggleClass(d,"after"===y).toggleClass(s,"before"===y).toggleClass(n,"over"===y).toggleClass(l,!1===y),y}var t=e.ui.fancytree,a="fancytree-drag-source",o="fancytree-drag-remove",n="fancytree-drop-accept",d="fancytree-drop-after",s="fancytree-drop-before",i="fancytree-drop-over",l="fancytree-drop-reject",p="fancytree-drop-target",f="application/x-fancytree-node",g=null,c=null,u=null,v=null;return e.ui.fancytree.registerExtension({name:"dnd5",version:"2.27.0",options:{autoExpandMS:1500,setTextTypeJson:!1,preventForeignNodes:!1,preventNonNodes:!1,preventRecursiveMoves:!0,preventVoidMoves:!0,scroll:!0,scrollSensitivity:20,scrollSpeed:5,dropMarkerOffsetX:-24,dropMarkerInsertOffsetX:-16,dragStart:null,dragDrag:e.noop,dragEnd:e.noop,dragEnter:null,dragOver:e.noop,dragExpand:e.noop,dragDrop:e.noop,dragLeave:e.noop},treeInit:function(d){var s,p=d.tree,y=d.options,b=y.glyph||null,h=y.dnd5,m=t.getNode;e.inArray("dnd",y.extensions)>=0&&e.error("Extensions 'dnd' and 'dnd5' are mutually exclusive."),h.dragStop&&e.error("dragStop is not used by ext-dnd5. Use dragEnd instead."),h.dragStart&&t.overrideMethod(d.options,"createNode",function(e,r){this._super.apply(this,arguments),r.node.span.draggable=!0}),this._superApply(arguments),this.$container.addClass("fancytree-ext-dnd5"),s=e("<span>").appendTo(this.$container),this.$scrollParent=s.scrollParent(),s.remove(),(g=e("#fancytree-drop-marker")).length||(g=e("<div id='fancytree-drop-marker'></div>").hide().css({"z-index":1e3,"pointer-events":"none"}).prependTo("body"),b&&t.setSpanIcon(g[0],b.map._addClass,b.map.dropMarker)),h.dragStart&&p.$container.on("dragstart drag dragend",function(r){var t,n=m(r),d=r.dataTransfer||r.originalEvent.dataTransfer,s="move"===d.dropEffect,i=n?e(n.span):null,l={node:n,tree:p,options:p.options,originalEvent:r,dataTransfer:d,isCancelled:void 0};switch(r.type){case"dragstart":e(n.span).addClass(a),c=n,t=JSON.stringify(n.toDict());try{d.setData(f,t),d.setData("text/html",e(n.span).html()),d.setData("text/plain",n.title)}catch(e){p.warn("Could not set data (IE only accepts 'text') - "+e)}return h.setTextTypeJson?d.setData("text",t):d.setData("text",n.title),d.effectAllowed="all",d.setDragImage&&d.setDragImage(e(n.span).find(".fancytree-title")[0],-10,-10),!1!==h.dragStart(n,l);case"drag":i.toggleClass(o,s),h.dragDrag(n,l);break;case"dragend":e(n.span).removeClass(a+" "+o),c=null,u=null,l.isCancelled="none"===d.dropEffect,g.hide(),h.dragEnd(n,l)}}),h.dragEnter&&p.$container.on("dragenter dragover dragleave drop",function(t){var a,o,d,s=null,y=m(t),b=t.dataTransfer||t.originalEvent.dataTransfer,x={node:y,tree:p,options:p.options,hitMode:u,originalEvent:t,dataTransfer:b,otherNode:c||null,otherNodeData:null,dropEffect:void 0,isCancelled:void 0};switch(t.type){case"dragenter":if(!y){p.debug("Ignore non-node "+t.type+": "+t.target.tagName+"."+t.target.className),u=!1;break}if(e(y.span).addClass(i).removeClass(n+" "+l),h.preventNonNodes&&!o){y.debug("Reject dropping a non-node"),u=!1;break}if(h.preventForeignNodes&&(!c||c.tree!==y.tree)){y.debug("Reject dropping a foreign node"),u=!1;break}setTimeout(function(){!h.autoExpandMS||!1===y.hasChildren()||y.expanded||h.dragExpand&&!1===h.dragExpand(y,x)||y.scheduleAction("expand",h.autoExpandMS)},0),g.show(),d=(!h.preventRecursiveMoves||!y.isDescendantOf(x.otherNode))&&function(r){var t;return!!r&&(t=e.isPlainObject(r)?{over:!!r.over,before:!!r.before,after:!!r.after}:e.isArray(r)?{over:e.inArray("over",r)>=0,before:e.inArray("before",r)>=0,after:e.inArray("after",r)>=0}:{over:!0===r||"over"===r,before:!0===r||"before"===r,after:!0===r||"after"===r},0!==Object.keys(t).length&&t)}(h.dragEnter(y,x)),u=d,s=d&&(d.over||d.before||d.after);break;case"dragover":s=!!(v=r(t,x));break;case"dragleave":if(!y){p.debug("Ignore non-node "+t.type+": "+t.target.tagName+"."+t.target.className);break}if(!e(y.span).hasClass(i)){y.debug("Ignore dragleave (multi)");break}e(y.span).removeClass(i+" "+n+" "+l),y.scheduleAction("cancel"),h.dragLeave(y,x),g.hide();break;case"drop":if(e.inArray(f,b.types)>=0&&(o=b.getData(f),p.info(t.type+": getData('application/x-fancytree-node'): '"+o+"'")),o||(o=b.getData("text"),p.info(t.type+": getData('text'): '"+o+"'")),o)try{void 0!==(a=JSON.parse(o)).title&&(x.otherNodeData=a)}catch(e){}p.debug(t.type+": nodeData: '"+o+"', otherNodeData: ",x.otherNodeData),e(y.span).removeClass(i+" "+n+" "+l),g.hide(),x.hitMode=v,x.dropEffect=b.dropEffect,x.isCancelled="none"===x.dropEffect,h.dragDrop(y,x),t.preventDefault()}if(s)return t.preventDefault(),!1})}}),e.ui.fancytree});
